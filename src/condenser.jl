...
mutable struct Condenser
    ...
    function Condenser(arg_vblocks::Vector{vblock}, arg_cblocks::Vector{cblock}, arg_hsizes::Vector{INT_T}, arg_targets::Vector{condensing_target}, arg_dep_bounds::INT_T = INT_T(1)) where INT_T <: Integer
        BSQP = libblockSQP2[]
        
        new_vblock_array_obj, new_cblock_array_obj, new_hsize_array_obj, new_target_array_obj = create_array_objects(arg_vblocks, arg_cblocks, arg_hsizes, arg_targets)
        ...
        Condenser(Condenser_obj, new_vblock_array_obj, new_cblock_array_obj, new_hsize_array_obj, new_target_array_obj)
    end
    
    Condenser(Condenser_obj::Ptr{Cvoid}, new_vblock_array_obj::Ptr{Cvoid}, new_cblock_array_obj::Ptr{Cvoid}, new_hsize_array_obj::Ptr{Cvoid}, new_target_array_obj::Ptr{Cvoid}) = begin
        BSQP = libblockSQP2[]
        ...
        nBlocks = ccall(@dlsym(BSQP, "Condenser_nBlocks"), Cint, (Ptr{Cvoid},), Condenser_obj)
        
        new_grad_obj = ccall(@dlsym(BSQP, "create_Matrix"), Ptr{Cvoid}, (Cint, Cint), nVar, Cint(1))
        new_constr_jac = ccall(@dlsym(BSQP, "create_Sparse_Matrix_default"), Ptr{Cvoid}, ())
        new_hess = ccall(@dlsym(BSQP, "create_SymMatrix_array"), Ptr{Cvoid}, (Cint,), nBlocks)
        for i = Cint(1):nBlocks
            ccall(@dlsym(BSQP, "SymMatrix_array_index_resize"), Cvoid, (Ptr{Cvoid}, Cint, Cint), new_hess, Cint(i - 1), ccall(@dlsym(BSQP, "hsize_array_get"), Cint, (Ptr{Cvoid}, Cint), new_hsize_array_obj, Cint(i - 1)))#Cint(arg_hsizes[i]))
        end
        new_lb_var = ccall(@dlsym(BSQP, "create_Matrix"), Ptr{Cvoid}, (Cint, Cint), nVar, Cint(1));
        new_ub_var = ccall(@dlsym(BSQP, "create_Matrix"), Ptr{Cvoid}, (Cint, Cint), nVar, Cint(1));
        new_lb_con = ccall(@dlsym(BSQP, "create_Matrix"), Ptr{Cvoid}, (Cint, Cint), nCon, Cint(1));
        new_ub_con = ccall(@dlsym(BSQP, "create_Matrix"), Ptr{Cvoid}, (Cint, Cint), nCon, Cint(1));
        
        condensed_nVar = ccall(@dlsym(BSQP, "Condenser_condensed_nVar"), Cint, (Ptr{Cvoid},), Condenser_obj)
        condensed_nCon = ccall(@dlsym(BSQP, "Condenser_condensed_nCon"), Cint, (Ptr{Cvoid},), Condenser_obj)
        condensed_nBlocks = ccall(@dlsym(BSQP, "Condenser_condensed_nBlocks"), Cint, (Ptr{Cvoid},), Condenser_obj)
        
        new_condensed_grad_obj = ccall(@dlsym(BSQP, "create_Matrix"), Ptr{Cvoid}, (Cint, Cint), condensed_nVar, Cint(1))
        new_condensed_constr_jac = ccall(@dlsym(BSQP, "create_Sparse_Matrix_default"), Ptr{Cvoid}, ())
        new_condensed_hess = ccall(@dlsym(BSQP, "create_SymMatrix_array"), Ptr{Cvoid}, (Cint,), condensed_nBlocks)
        new_condensed_lb_var = ccall(@dlsym(BSQP, "create_Matrix_default"), Ptr{Cvoid}, ());
        new_condensed_ub_var = ccall(@dlsym(BSQP, "create_Matrix_default"), Ptr{Cvoid}, ());
        new_condensed_lb_con = ccall(@dlsym(BSQP, "create_Matrix_default"), Ptr{Cvoid}, ());
        new_condensed_ub_con = ccall(@dlsym(BSQP, "create_Matrix_default"), Ptr{Cvoid}, ());
        
        new_xi_cond = ccall(@dlsym(BSQP, "create_Matrix"), Ptr{Cvoid}, (Cint, Cint), condensed_nVar, Cint(1))
        new_lambda_cond = ccall(@dlsym(BSQP, "create_Matrix"), Ptr{Cvoid}, (Cint, Cint), condensed_nVar + condensed_nCon, Cint(1))
        
        new_xi_rest = ccall(@dlsym(BSQP, "create_Matrix"), Ptr{Cvoid}, (Cint, Cint), nVar, Cint(1))
        new_lambda_rest = ccall(@dlsym(BSQP, "create_Matrix"), Ptr{Cvoid}, (Cint, Cint), nVar + nCon, Cint(1))
        ...
        function Condenser_finalizer!(J_cond::Condenser)
            ...
            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_xi_cond)

            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_condensed_ub_con)
            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_condensed_lb_con)
            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_condensed_ub_var)
            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_condensed_lb_var)
            ccall(@dlsym(BSQP, "delete_SymMatrix_array"), Cvoid, (Ptr{Cvoid},), J_cond.SymMatrix_array_condensed_hess)
            ccall(@dlsym(BSQP, "delete_Sparse_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Sparse_Matrix_condensed_constr_jac)
            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_condensed_grad_obj)

            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_ub_con)
            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_lb_con)
            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_ub_var)
            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_lb_var)
            ccall(@dlsym(BSQP, "delete_SymMatrix_array"), Cvoid, (Ptr{Cvoid},), J_cond.SymMatrix_array_hess)
            ccall(@dlsym(BSQP, "delete_Sparse_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Sparse_Matrix_constr_jac)
            ccall(@dlsym(BSQP, "delete_Matrix"), Cvoid, (Ptr{Cvoid},), J_cond.Matrix_grad_obj)

            ccall(@dlsym(BSQP, "delete_Condenser"), Cvoid, (Ptr{Cvoid},), J_cond.Condenser_obj)
...
function create_array_objects(arg_vblocks::Vector{vblock}, arg_cblocks::Vector{cblock}, arg_hsizes::Vector{INT_T}, arg_targets::Vector{condensing_target}) where INT_T <: Integer
    BSQP = libblockSQP2[]
    ...
    for i = 1:length(arg_cblocks)
        ccall(@dlsym(BSQP, "cblock_array_set"), Cvoid, (Ptr{Cvoid}, Cint, Cint), new_cblock_array_obj, Cint(i - 1), Cint(arg_cblocks[i].size))
    end
    new_hsize_array_obj = ccall(@dlsym(BSQP, "create_hsize_array"), Ptr{Cvoid}, (Cint,), Cint(length(arg_hsizes)))
    for i = 1:length(arg_hsizes)
        ccall(@dlsym(BSQP, "hsize_array_set"), Cvoid, (Ptr{Cvoid}, Cint, Cint), new_hsize_array_obj, Cint(i - 1), Cint(arg_hsizes[i]))
    end
    ...
    return new_vblock_array_obj, new_cblock_array_obj, new_hsize_array_obj, new_target_array_obj
end
...
function full_condense!(J_cond::Condenser, grad_obj::Vector{Float64}, constr_jac::Sparse_Matrix, hess::Vector{Matrix{Float64}}, lb_var::Vector{Float64}, ub_var::Vector{Float64}, lb_con::Vector{Float64}, ub_con::Vector{Float64})
    ...
    nCon = ccall(@dlsym(BSQP, "Condenser_nCon"), Cint, (Ptr{Cvoid},), cond)
    nBlocks = ccall(@dlsym(BSQP, "Condenser_nBlocks"), Cint, (Ptr{Cvoid},), cond)
    
    nnz = Cint(length(constr_jac.nz))
    @assert nnz == constr_jac.colind[constr_jac.n + 1]
    
    unsafe_wrap(Vector{Cdouble}, 
                ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_grad_obj), 
                Cint(nVar);
                own = false
                )[:] = grad_obj
    
    ccall(@dlsym(BSQP, "Sparse_Matrix_set_structure"), Cvoid, (Ptr{Cvoid}, Cint, Cint, Cint), J_cond.Sparse_Matrix_constr_jac, nCon, nVar, nnz)
    
    unsafe_wrap(Vector{Cdouble}, 
                ccall(@dlsym(BSQP, "Sparse_Matrix_nz"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Sparse_Matrix_constr_jac), 
                nnz; 
                own = false
                )[:] = constr_jac.nz
    
    unsafe_wrap(Vector{Cint}, 
                ccall(@dlsym(BSQP, "Sparse_Matrix_row"), Ptr{Cint}, (Ptr{Cvoid},), J_cond.Sparse_Matrix_constr_jac), 
                nnz; 
                own = false
                )[:] = constr_jac.row
    
    unsafe_wrap(Vector{Cint}, 
                ccall(@dlsym(BSQP, "Sparse_Matrix_colind"), Ptr{Cint}, (Ptr{Cvoid},), J_cond.Sparse_Matrix_constr_jac), 
                Cint(constr_jac.n + 1);
                own = false
                )[:] = constr_jac.colind
    ...
    hsizes = unsafe_wrap(Vector{Cint}, 
                         ccall(@dlsym(BSQP, "Condenser_hsizes"), Ptr{Cint}, (Ptr{Cvoid},), cond), 
                         nBlocks; 
                         own = false)
    for i = Cint(1):nBlocks
        hsize = hsizes[i]
        hessblock_data = unsafe_wrap(Vector{Cdouble}, 
                                     ccall(@dlsym(BSQP, "SymMatrix_array_index_array"), Ptr{Cdouble}, (Ptr{Cvoid}, Cint), J_cond.SymMatrix_array_hess, Cint(i - 1)), 
    ...
    unsafe_wrap(Vector{Cdouble},
                ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_lb_var),
                nVar;
                own = false
                )[:] = lb_var
    
    unsafe_wrap(Vector{Cdouble},
                ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_ub_var),
                nVar;
                own = false
                )[:] = ub_var
    
    unsafe_wrap(Vector{Cdouble},
                ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_lb_con),
                nCon;
                own = false
                )[:] = lb_con
    
    unsafe_wrap(Vector{Cdouble},
                ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_ub_con),
                nCon;
                own = false
                )[:] = ub_con
    ...
    condensed_nnz = ccall(@dlsym(BSQP, "Sparse_Matrix_nnz"), Cint, (Ptr{Cvoid},), J_cond.Sparse_Matrix_condensed_constr_jac)
    
    condensed_grad_obj = Vector{Cdouble}(undef, condensed_nVar)
    condensed_grad_obj[:] = unsafe_wrap(Vector{Cdouble},
                                        ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_condensed_grad_obj),
                                        condensed_nVar;
                                        own = false
                                        )
    ...
    condensed_constr_jac.nz[:] = unsafe_wrap(Vector{Cdouble},
                                             ccall(@dlsym(BSQP, "Sparse_Matrix_nz"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Sparse_Matrix_condensed_constr_jac),
                                             condensed_nnz;
                                             own = false
                                             )
    condensed_constr_jac.row[:] = unsafe_wrap(Vector{Cint},
                                              ccall(@dlsym(BSQP, "Sparse_Matrix_row"), Ptr{Cint}, (Ptr{Cvoid},), J_cond.Sparse_Matrix_condensed_constr_jac),
                                              condensed_nnz;
                                              own = false
                                              )
    condensed_constr_jac.colind[:] = unsafe_wrap(Vector{Cint},
                                                 ccall(@dlsym(BSQP, "Sparse_Matrix_colind"), Ptr{Cint}, (Ptr{Cvoid},), J_cond.Sparse_Matrix_condensed_constr_jac),
                                                 condensed_nVar + 1;
                                                 own = false
                                                 )
    
    condensed_nBlocks = ccall(@dlsym(BSQP, "Condenser_condensed_nBlocks"), Cint, (Ptr{Cvoid},), cond)
    condensed_hsizes = unsafe_wrap(Vector{Cint}, 
                                   ccall(@dlsym(BSQP, "Condenser_condensed_hsizes"), Ptr{Cint}, (Ptr{Cvoid},), cond),
                                   condensed_nBlocks;
                                   own = false)
    ...
    condensed_lb_var[:] = unsafe_wrap(Vector{Cdouble},
                                      ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_condensed_lb_var),
                                      condensed_nVar;
                                      own = false
                                      )
    condensed_ub_var[:] = unsafe_wrap(Vector{Cdouble},
                                      ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_condensed_ub_var),
                                      condensed_nVar;
                                      own = false
                                      )
    condensed_lb_con[:] = unsafe_wrap(Vector{Cdouble},
                                      ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_condensed_lb_con),
                                      condensed_nCon;
                                      own = false
                                      )
    condensed_ub_con[:] = unsafe_wrap(Vector{Cdouble},
                                      ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_condensed_ub_con),
                                      condensed_nCon;
                                      own = false
                                      )
...
function recover_var_mult(J_cond::Condenser, xi_cond::Array{Float64, 1}, lambda_cond::Array{Float64, 1})
    ...
    unsafe_wrap(Vector{Cdouble},
                ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_xi_cond),
                condensed_nVar;
                own = false
                )[:] = xi_cond
    unsafe_wrap(Vector{Cdouble},
                ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_lambda_cond),
                condensed_nVar + condensed_nCon;
                own = false
                )[:] = lambda_cond
    
    ccall(@dlsym(BSQP, "Condenser_recover_var_mult"), Cvoid, 
    ...
    xi_rest[:] = unsafe_wrap(Vector{Cdouble},
                             ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_xi_rest),
                             nVar;
                             own = false
                             )
    lambda_rest[:] = unsafe_wrap(Vector{Cdouble},
                                 ccall(@dlsym(BSQP, "Matrix_array"), Ptr{Cdouble}, (Ptr{Cvoid},), J_cond.Matrix_lambda_rest),
                                 nVar + nCon;
                                 own = false
                                 )
...
function PartialCondenser(arg_vblocks::Vector{vblock}, arg_cblocks::Vector{cblock}, arg_hsizes::Vector{INT_T}, arg_targets::Vector{condensing_target}, arg_N_pcond::INT_T, arg_dep_bounds::INT_T = 1) where INT_T <: Integer
    BSQP = libblockSQP2[]
    
    new_vblock_array_obj, new_cblock_array_obj, new_hsize_array_obj, new_target_array_obj = create_array_objects(arg_vblocks, arg_cblocks, arg_hsizes, arg_targets)
    
    Condenser_obj = ccall(@dlsym(BSQP, "create_PartialCondenser"), Ptr{Cvoid}, (Ptr{Cvoid}, Cint, Ptr{Cvoid}, Cint, Ptr{Cvoid}, Cint, Ptr{Cvoid}, Cint, Cint, Cint), new_vblock_array_obj, Cint(length(arg_vblocks)), new_cblock_array_obj, Cint(length(arg_cblocks)), new_hsize_array_obj, Cint(length(arg_hsizes)), new_target_array_obj, Cint(length(arg_targets)), Cint(arg_N_pcond), Cint(arg_dep_bounds))
    if Condenser_obj == C_NULL
        ccall(@dlsym(BSQP, "delete_target_array"), Cvoid, (Ptr{Cvoid},), J_cond.target_array_obj)
        ccall(@dlsym(BSQP, "delete_hsize_array"), Cvoid, (Ptr{Cvoid},), J_cond.hsize_array_obj)
        ccall(@dlsym(BSQP, "delete_cblock_array"), Cvoid, (Ptr{Cvoid},), J_cond.cblock_array_obj)
    ...
    return Condenser(Condenser_obj, new_vblock_array_obj, new_cblock_array_obj, new_hsize_array_obj, new_target_array_obj)
end
